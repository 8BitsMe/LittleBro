...
ClickY(Why, timeout := 10){
     WaitFoRButton(1, Why, 0.12, 0.825, 0.28, 0.93, 0x549060, timeout)
}

ClickZ(Why, timeout := 10){
     WaitFoRButton(1, Why, 0.58, 0.825, 0.74, 0.93, 0x549060, timeout)
}
